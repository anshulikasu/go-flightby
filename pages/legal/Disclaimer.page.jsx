  ...
  return (
    <div className="cm-legal-content-container">
      ...
      <div className="cm-section cm-page-center cm-lr-pad">
        ...
        <p>
          Flight hub deal uses reasonable efforts to ensure that information contained
          ...
          to and remain solely with Flight hub deal. Users are solely responsible for
          the use and protection of their user ID/ password used on our website.
        </p>
        <p>
          Flight hub deal is not responsible in any way for the content, claims,

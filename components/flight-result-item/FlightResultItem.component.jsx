...
const FlightResultItem = ({
  ...
  const calcTaxes = () => {
    ...
    return (parseFloat(flData.price.grandTotal) * (airlineTax / 100)).toFixed(
      2
    );
  };
  ...
  return (
    <div className="cm-fl-res-item">
      <div className="cm-fl-res-item-header cm-flex-type-1">
        ...
        <div className="cm-col cm-col2">
          <p className="cm-price-label">Total Fare + Taxes</p>
          <p className="cm-price-calc">
            ${flData.price.grandTotal} + ${calcTaxes()} =
          </p>
          <h3>
            ${' '}
            {(
              parseFloat(flData.price.grandTotal) + parseFloat(calcTaxes())
            ).toFixed(2)}
          </h3>
        </div>
        {/* <div className="cm-col cm-col2">

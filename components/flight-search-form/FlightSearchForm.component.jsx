  ...
  return (
    <div className="cm-fl-search-form">
      ...
      <div className="cm-mid-wrap cm-flex cm-flex-wrap cm-flex-sb">
        <div className="cm-form-field cm-srch-inp cm-wd-100">
          <SearchInputs
        ...
        <div className="select-type cm-wd-100">
        ...
        <div className="cm-fl-search-btn cm-wd-100">
          <button
            onClick={handleFormSubmit}
            className="cm-btn cm-white-col"
          >
            Search
          </button>
        </div>
